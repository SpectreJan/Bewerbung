...
\input{meta.tex}
\input{\bewerberInfos}
\usepackage{Vorlage_Bewerbung_EN}
...
%%%%%%%%%% CV %%%%%%%%%% 
\begin{filecontents}{cvGen_EN.tex}
\PassOptionsToPackage{dvipsnames}{xcolor}
\documentclass[12pt,a4paper,sans]{moderncv} 
\usepackage[breit]{Vorlage_Lebenslauf_EN}
\usepackage[utf8x]{inputenc}
...
\end{document}
\end{filecontents}
\immediate\write18{pdflatex  -output-directory="\buildDir" cvGen_EN.tex}
...
\IfFileExists{\buildDir cvGen.pdf}{
	...
	\includepdf[pages=-]{\buildDir cvGen_EN}
}{
